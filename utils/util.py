...
def parse_multipolygon(coords_str):
    polygons = coords_str.split(';')
    multipolygon = []
    for poly in polygons:
        coords = [tuple(map(float, coord.split())) for coord in poly.split(',')]
